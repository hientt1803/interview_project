...
<%@ page contentType="text/html; charset=UTF-8" language="java" %>
    ...
    <c:if test="${addEmpSuccess}">
      <span class="my-4 bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">Successfully added Employee with ID: ${saveEmp.emp_id}</span>
    </c:if>
    ...
    <h3 class="text-3xl font-bold dark:text-white mb-3 mt-5">Create new Employee</h3>
    <c:url var="add_emp_url" value="/employees/add-emp"/>
    <form:form action="${add_emp_url}" id="employeeForm" method="post" modelAttribute="employee">
        <div class="grid gap-6 mb-6 md:grid-cols-2">
          <div>
            <form:label path="emp_id" cssClass="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Employee ID: </form:label> 
            <form:input type="text" id="emp_id" path="emp_id" cssClass="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
          ...
          <div>
            ...
            <form:input type="email" id="email" path="email" cssClass="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
          ...
          <div>
            ...
            <form:input type="text" id="name" path="name" cssClass="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
          ...
          <div>
            ...
            <form:input type="number" id="phone_number" path="phone_number" cssClass="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
          ...
          <button type="submit" value="submit" class="text-white bg-[#050708] hover:bg-[#050708]/90 focus:ring-4 focus:outline-none focus:ring-dark-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-dark-600 dark:hover:bg-dark-700 dark:focus:ring-dark-800">Submit</button>
    </form:form>
